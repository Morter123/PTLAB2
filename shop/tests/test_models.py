...
class ProductTestCase(TestCase):
    def setUp(self):
        Product.objects.create(name="book", price="740", stock="3")
        Product.objects.create(name="pencil", price="50", stock="0")
    ...
    def test_correctness_types(self):                   
        ...
        self.assertIsInstance(Product.objects.get(name="book").stock, int)
        ...
        self.assertIsInstance(Product.objects.get(name="pencil").stock, int)        
                

    def test_correctness_data(self):
        self.assertTrue(Product.objects.get(name="book").price == 740)
        self.assertTrue(Product.objects.get(name="book").stock == 3)
        self.assertTrue(Product.objects.get(name="pencil").price == 50)
        self.assertTrue(Product.objects.get(name="pencil").stock == 0)
        


class PurchaseTestCase(TestCase):
    def setUp(self):
        self.product_book = Product.objects.create(name="book", price="740", stock="3")
